...
POSE_EDGES = [
    ...
    (0, 1),
    (1, 2),
    (2, 3),  # nose -> left eye -> left ear
    (0, 4),
    (4, 5),
    (5, 6),  # nose -> right eye -> right ear
    (0, 7),  # nose -> left mouth
    (0, 8),  # nose -> right mouth
    # Torso
    (11, 12),  # left shoulder -> right shoulder
    (11, 23),
    (23, 24),  # left shoulder -> left hip -> right hip
    (12, 24),  # right shoulder -> right hip
    # Left arm
    (11, 13),
    (13, 15),  # left shoulder -> elbow -> wrist
    # Right arm
    (12, 14),
    (14, 16),  # right shoulder -> elbow -> wrist
    # Left leg
    (23, 25),
    (25, 27),  # left hip -> knee -> ankle
    (27, 29),
    (29, 31),  # ankle -> heel -> toe
    # Right leg
    (24, 26),
    (26, 28),  # right hip -> knee -> ankle
    (28, 30),
    (30, 32),  # ankle -> heel -> toe
