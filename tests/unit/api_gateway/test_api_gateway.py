...
class TestHealthEndpoints:
    ...
    def test_status_degraded_when_vision_unhealthy(self, gateway_client, mock_vision_client):
...
class TestStaticPredictionEndpoint:
    ...
    def test_predict_static_success(self, gateway_client, mock_vision_client, mock_landmarks, mock_vision_response):
    ...
    def test_predict_static_invalid_landmarks(self, gateway_client):
        ...
        response = gateway_client.post(
            "/api/v1/predict/static",
            json={"landmarks": [[0.5, 0.5]]}  # Solo 2 coords
        )
...
class TestDynamicPredictionEndpoint:
    ...
    def test_predict_dynamic_success(self, gateway_client, mock_vision_client, mock_sequence, mock_vision_response):
...
class TestWordPredictionEndpoint:
    ...
    def test_predict_word_success(self, gateway_client, mock_vision_client, mock_sequence, mock_word_response):
...
class TestHolisticPredictionEndpoint:
    ...
    def test_predict_holistic_success(self, gateway_client, mock_vision_client, mock_holistic_landmarks, mock_word_response):
...
class TestBufferManagementEndpoints:
    ...
    def test_clear_word_buffer(self, gateway_client, mock_vision_client):
        ...
        mock_vision_client["clear_word_buffer"].return_value = {"message": "Buffer cleared"}
    ...
    def test_clear_holistic_buffer(self, gateway_client, mock_vision_client):
        ...
        mock_vision_client["clear_holistic_buffer"].return_value = {"message": "Buffer cleared"}
...
class TestErrorHandling:
    ...
    def test_vision_service_timeout(self, gateway_client, mock_vision_client, mock_landmarks):
    ...
    def test_vision_service_unavailable(self, gateway_client, mock_vision_client, mock_landmarks):
