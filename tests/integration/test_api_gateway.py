...
class TestAPIGatewayToVisionProxy:
    ...
    def test_static_prediction_through_gateway(
        self, gateway_sync_client, sample_landmarks
    ):
    ...
    def test_dynamic_prediction_through_gateway(
        self, gateway_sync_client, sample_sequence
    ):
    ...
    def test_words_prediction_through_gateway(
        self, gateway_sync_client, sample_sequence
    ):
    ...
    def test_holistic_prediction_through_gateway(
        self, gateway_sync_client, sample_holistic_features
    ):
...
class TestAPIGatewayErrorHandling:
    ...
    def test_invalid_landmarks_returns_422(self, gateway_sync_client):
        ...
        response = gateway_sync_client.post(
            "/api/v1/predict/static", json={"landmarks": [[0.5]]}  # Inválido
        )
    ...
    def test_invalid_sequence_returns_422(self, gateway_sync_client):
        ...
        response = gateway_sync_client.post(
            "/api/v1/predict/dynamic", json={"sequence": []}  # Inválido
        )
