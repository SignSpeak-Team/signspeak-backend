...
class TestStaticPredictionIntegration:
    ...
    def test_static_prediction_returns_letter(self, vision_sync_client, sample_landmarks):
...
class TestDynamicPredictionIntegration:
    ...
    def test_dynamic_prediction_returns_letter(self, vision_sync_client, sample_sequence):
...
class TestHolisticPredictionIntegration:
    ...
    def test_holistic_prediction_returns_word(self, vision_sync_client, sample_holistic_features):
